...
| 0018 | **Steps 5/6 deferred — AV1 is the premium path (#53)** — A/B (graphics @ VMAF95): x265-veryslow ~74% / x264 ~43% / AV1 ~81% smaller than VT-HEVC. Licensed x264/x265 premium NOT worth the GPL+patent spend (AV1 covers premium, royalty-free). Convex-hull marginal for single-rendition signage. **Flagged #59: VT-HEVC default-path inefficiency on graphics (no-cost fix)** | Accepted |
