# ADR 0018 — Still quality-target search reuses the FormatBridge scorer/search seam
...
3. **Lossless short-circuit.** When the target format is lossless (PNG via oxipng, ADR-0017),
...
- [ADR-0016](0016-imagebridge-sibling-package.md), [ADR-0017](0017-still-ship-encoder.md)
