# ADR 0020 — Still ship-encoder: ImageIO native + oxipng lossless; lossy palette quant gated out
...
- [ADR-0019](0019-imagebridge-sibling-package.md), [ADR-0021](0021-still-quality-target-search.md)
